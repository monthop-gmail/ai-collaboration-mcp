...
- **ชื่อ** ของ D1 ยังเป็น `ai-collab` ตามที่เขียนไว้ใน `wrangler.jsonc` (ส่วน id ถูกเปลี่ยน
  เป็นของคุณแล้ว) ไม่เสียหายเพราะคนละบัญชี แต่ถ้ามี `ai-collab` อยู่แล้วจะสับสน
  แก้ `database_name` ได้หลังกดปุ่ม
