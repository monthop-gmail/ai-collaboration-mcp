...
CREATE TABLE IF NOT EXISTS decisions (
  ...
  -- ใครเปลี่ยนค่า `scope` ล่าสุด และเมื่อไหร่ — ว่างแปลว่าไม่มีใครเคยแตะ
  --
  -- **คนละเรื่องกับ `decided_by` ที่อยู่ข้างบน** นั่นคือคนปิดใบ ส่วนนี่คือคนปักกติกา
  -- สองอย่างนี้เกิดคนละเวลา ด้วยหลักฐานคนละระดับ และเคยเป็นคนละคนมาแล้ว
  --
  -- ไม่มีคอลัมน์บอกระดับหลักฐานของการปัก เพราะมีทางเดียวคือส่ง APPROVAL_SECRET
  -- ที่ถูกต้อง ค่าจึงเป็นค่าเดียวเสมอ คอลัมน์ที่มีค่าเดียวไม่ได้บอกอะไรใคร
  --
